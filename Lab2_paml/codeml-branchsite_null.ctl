     ...
     treefile = Mx_branch_duckchicken.tree           * Path to the tree file
      outfile = out_duckchicken_branchsite_null.txt            * Path to the output file
   
        noisy = 0              * How much rubbish on the screen
      verbose = 0              * More or less detailed report
