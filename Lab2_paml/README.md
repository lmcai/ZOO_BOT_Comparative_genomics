# Estimating dN/dS rate using PAML
...
`codeml` is the main program we will use to estimate dS and dN values, it will look for a control file with all input parameters. The installation package should have some example control file you can try, but otherwise we will go through the preparation of this input file in class.
